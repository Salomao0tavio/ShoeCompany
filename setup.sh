...
GIT_USERNAME=Salomao0tavio
GIT_EMAIL=otavio.ferreira.mds@gmail.com
...
DEPLOY_USER="SalomaoOtavio$(openssl rand -hex 5)"
DEPLOY_PASSWORD="Otavio@pis123$(openssl rand -hex 10)"
